...
struct FInv_ImageFragment:public FInv_InventoryItemFragment
{
	...
	FVector2D GetIconDimension()const{return IconDimension;}
...
struct FInv_ConsumeModifier:public FInv_LabeledNumberFragment
{
	...
	UPROPERTY(EditAnywhere,Category = "Inventory|GameplayEffec")
	FGameplayTag ConsumeAttributeTag;
	UPROPERTY(EditAnywhere,Category = "Inventory|GameplayEffec")
...
struct FInv_EquipModifier:public FInv_LabeledNumberFragment
{
	...
	UPROPERTY(EditAnywhere,Category = "Inventory|GameplayEffec")
	FGameplayTag EquipAttributeTag;
	UPROPERTY(EditAnywhere,Category = "Inventory|GameplayEffec")
	TSubclassOf<UGameplayEffect>EquipGameplayEffectClass;
};
USTRUCT(BlueprintType)
struct FInv_IntelligenceModifier:public FInv_EquipModifier
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FInv_VigorModifier:public FInv_EquipModifier
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FInv_ResilienceModifier:public FInv_EquipModifier
{
	GENERATED_BODY()
