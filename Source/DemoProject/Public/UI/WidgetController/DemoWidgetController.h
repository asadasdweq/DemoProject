...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FAbilityInfoDelegate, const FDemoAbilityInfo&,Info);
...
UCLASS()
class DEMOPROJECT_API UDemoWidgetController : public UObject
{
	GENERATED_BODY()
public:
	...
	void BroadAbilityInfo();
	
	ADemoPlayerController* GetDemoPC();
	ADemoPlayerState* GetDemoPS();
	UDemoAbilitySystemComponent* GetDemoASC();
	UDemoAttributeSet* GetDemoAS();
protected:
	...
	UPROPERTY(BlueprintReadOnly, Category = "WidgetController")
	TObjectPtr <ADemoPlayerController>DemoPlayerController;
	UPROPERTY(BlueprintReadOnly, Category = "WidgetController")
	TObjectPtr<ADemoPlayerState>DemoPlayerState;
	UPROPERTY(BlueprintReadOnly, Category = "WidgetController")
