 ...
 * 
 */
DECLARE_DYNAMIC_DELEGATE_TwoParams(FPopUpMenuSplit,int32, SplitAmount,int32,Amount);
...
UCLASS()
class DEMOPROJECT_API UInv_ItemPopUp : public UUserWidget
{
	GENERATED_BODY()
public:
	...
	FPopUpMenuConsume OnDrop;
	FPopUpMenuDrop OnConsume;
