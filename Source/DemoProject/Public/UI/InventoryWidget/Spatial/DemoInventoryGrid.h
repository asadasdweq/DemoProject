...
#include "DemoInventoryGrid.generated.h"
 ...
 */
UCLASS()
class DEMOPROJECT_API UDemoInventoryGrid : public UUserWidget
{
	GENERATED_BODY()
public:
...
private:
	...
	void AddItemToIndices(const FInv_SlotAvailabilityResult&Result,UInv_InventoryItem*InventoryItem);
	...
	bool DoesItemTypeMatch(const UInv_InventoryItem*InventoryItem,const FGameplayTag &ItemType)const;
	...
	void ChangeHoverType(const int32 Index,const FIntPoint&Dimensions,EGridSlotSlate GridSlotSlate);
