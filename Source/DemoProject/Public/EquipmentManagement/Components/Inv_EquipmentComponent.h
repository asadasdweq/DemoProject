...
class DEMOPROJECT_API UInv_EquipmentComponent : public UActorComponent
{
	GENERATED_BODY()
...
private:
	...
	AInv_EquipActor*SpawnEquippedActor(FInv_EquipmentFragment
		*EquipmentFragment,const FInv_ItemManifest&Manifest,USkeletalMeshComponent*AttachMesh);
